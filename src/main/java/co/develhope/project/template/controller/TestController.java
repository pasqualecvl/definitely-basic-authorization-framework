...
public class TestController {
	...
	public void noRoleEndpoint() {
		System.out.println("This endpoint can be reached with any role, but require authentication");
	}

	@RoleSecurity(value = { "ROLE_ADMIN", "ROLE_PUBLISHER" })
	@GetMapping("/role-evaluated-endpoint")
	public void roleCheckEndpoint() {
		System.out.println("This endpoint can be reached only by authenticated users with ROLE_ADMIN or ROLE_PUBLISHER");
	}
